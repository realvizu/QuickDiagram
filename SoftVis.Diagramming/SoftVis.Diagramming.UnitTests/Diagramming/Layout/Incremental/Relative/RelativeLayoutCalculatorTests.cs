...
namespace Codartis.SoftVis.Diagramming.UnitTests.Diagramming.Layout.Incremental.Relative
{
    public class RelativeLayoutCalculatorTests
    {
        ...
        public void OnDiagramConnectorAdded_SourceVertexMoved()
        {
            ...
            AssertChangeEvent("B", new RelativeLocation(1, 0), new RelativeLocation(0, 1));
        }
        ...
        public void OnDiagramConnectorAdded_SourceVertexMoved2Layers()
        {
            ...
            AssertChangeEvent("C", new RelativeLocation(2, 0), new RelativeLocation(0, 1));
        }

        [Fact]
        public void OnDiagramConnectorAdded_DummyVertexAdded()
        {
            ...
            AssertAssignEvent("Dummy#1", new RelativeLocation(1, 1));
        }

        [Fact]
        public void OnDiagramConnectorAdded_DummyVertexRemoved()
        {
        }
        ...
        public void OnDiagramConnectorAdded_SourceVertexTreeMoved()
        {
            ...
            AssertChangeEvent("A", new RelativeLocation(1, 0), new RelativeLocation(0, 0));
            AssertChangeEvent("B", new RelativeLocation(2, 0), new RelativeLocation(1, 0));
            AssertChangeEvent("C", new RelativeLocation(2, 1), new RelativeLocation(1, 1));
        }
        ...
        public void OnDiagramConnectorAdded_ChildIsAlsoSibling()
        {
            ...
            AssertChangeEvent("A", new RelativeLocation(1, 0), new RelativeLocation(0, 0));
            AssertChangeEvent("B", new RelativeLocation(2, 0), new RelativeLocation(1, 0));
            AssertChangeEvent("C", new RelativeLocation(3, 0), new RelativeLocation(2, 0));
        }
        ...
        private void AssertChangeEvent(string vertexName, RelativeLocation to, RelativeLocation? from = null)
        {
            _calculator.ShouldRaise(nameof(RelativeLayoutCalculator.LayoutActionExecuted))
                .WithArgs<LayoutVertexAction>(i => i.Vertex.Name == vertexName
                && i is RelativeLocationChangedLayoutAction
                && ((RelativeLocationChangedLayoutAction)i).To == to
                && (from == null || ((RelativeLocationChangedLayoutAction)i).From == from));
        }
        ...
        {
            return _calculator.RelativeLayout.LayeredLayoutGraph.Vertices
                .Any(i => i.Name == vertexName);
        }

        private bool EdgeAlreadyAddedToCalculator(EdgeSpecification edgeSpecification)
        {
            return _calculator.RelativeLayout.LayeredLayoutGraph.Edges
