...
namespace Codartis.SoftVis.VisualStudioIntegration.Modeling.Implementation
{
    ...
    public class RoslynBasedModelBuilder : IModelServices
    {
        ...
        public IReadOnlyModel ReadOnlyModel => _model;

        public IRoslynBasedModelEntity GetOrAddRoslynSymbol(INamedTypeSymbol namedTypeSymbol)
        {
        ...
        // TODO: make it async
        public void FindAndAddRelatedEntities(IRoslynBasedModelEntity modelEntity)
        {
            modelEntity
