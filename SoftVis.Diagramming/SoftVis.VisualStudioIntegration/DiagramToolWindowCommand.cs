//------------------------------------------------------------------------------
// <copyright file="DiagramToolWindowCommand.cs" company="Company">
...
namespace Codartis.SoftVis.VisualStudioIntegration
{
    ...
    internal sealed class DiagramToolWindowCommand
    {
        ...
        private DiagramToolWindowCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static DiagramToolWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        private void ShowToolWindow(object sender, EventArgs e)
        {
            ...
            var window = (DiagramToolWindow)this.package.FindToolWindow(typeof(DiagramToolWindow), 0, true);
