...
{
    internal class SugiEdge : TaggedEdge<SugiVertex, IEdge<ISized>>
    {
        internal SugiEdge(IEdge<ISized> originalEdge, SugiVertex source, SugiVertex target)
            : base(source, target, originalEdge) { }

        public IEdge<ISized> OriginalEdge => Tag;
