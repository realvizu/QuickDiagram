...
namespace Codartis.SoftVis.Rendering.Wpf.DiagramRendering.ShapeControls.MiniButtons
{
    ...
    internal class ShowRelatedEntityMiniButton : MiniButtonBase
    {
        ...
        {
            return new Rect(AdornedElement.DesiredSize).GetRelativePoint(_miniButtonDescriptor.Location);
        }
        ...
        private System.Windows.Media.Geometry GetConnectorGeometry(ConnectorStyle connectorStyle)
        {
            // TODO
            return null;
        }
