...
namespace Codartis.SoftVis.Diagramming.Graph.Layout.VertexPlacement.SimplifiedSugiyama
{
    internal sealed class LayoutGraph : BidirectionalGraph<LayoutVertex, LayoutEdge>
    {
        ...
        private readonly IDictionary<IEdge<IExtent>, IList<LayoutVertex>> _edgeToDummyVerticesMap;
        ...
        public LayoutGraph(IEnumerable<IExtent> originalVertice, IEnumerable<IEdge<IExtent>> originalEdges)
        {
            ...
            _edgeToDummyVerticesMap = new Dictionary<IEdge<IExtent>, IList<LayoutVertex>>();
        ...
        public IDictionary<IEdge<IExtent>, DiagramPoint[]> GetInterimRoutePointsOfEdges()
        {
