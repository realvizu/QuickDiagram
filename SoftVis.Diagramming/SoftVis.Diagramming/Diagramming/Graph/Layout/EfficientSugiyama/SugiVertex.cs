...
namespace Codartis.SoftVis.Diagramming.Graph.Layout.EfficientSugiyama
{
    ...
    internal class SugiVertex : Data
    {
        ...
        public readonly double[] HorizontalPositions = { NaN, NaN, NaN, NaN };
        public double HorizontalPosition = NaN;
        public double VerticalPosition = NaN;

        public readonly SugiVertex[] Roots = new SugiVertex[4];
        public readonly SugiVertex[] Aligns = new SugiVertex[4];
        public readonly double[] BlockWidths = { NaN, NaN, NaN, NaN };
