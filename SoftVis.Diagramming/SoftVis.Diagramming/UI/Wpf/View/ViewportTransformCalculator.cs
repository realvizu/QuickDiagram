...
namespace Codartis.SoftVis.UI.Wpf.View
{
    ...
    /// </summary>
    internal static class ViewportTransformCalculator
    {
        public static Transform CreateTransformToScreenSpace(Size viewportSizeInScreenSpace, double zoom, Point centerInDiagramSpace)
        {
