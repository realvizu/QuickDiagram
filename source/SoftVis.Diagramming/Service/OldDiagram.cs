...
//        private readonly ImmutableDiagramGraph _graph;
//        private readonly IDiagramShapeFactory _diagramNodeFactory;
...
//        public Diagram(IModelProvider modelProvider, DiagramBuilderBase diagramBuilder, IDiagramShapeFactory diagramNodeFactory)
//        {
...
//        public void RerouteDiagramConnector(IDiagramConnector diagramConnector, Route newRoute) => diagramConnector.Route = newRoute;
...
//        {
//            var sourceNode = FindDiagramNode(relationship.Source.Id);
//            var targetNode = FindDiagramNode(relationship.Target.Id);
...
//                    if (pathToHide != null)
//                    {
//                        var diagramConnector = FindDiagramConnector(pathToHide[0].ModelRelationship.Id) as DiagramConnector;
//                        RemoveDiagramConnector(diagramConnector);
//                    }
//                }
//            }
...
//            lock (_graph.SyncRoot)
//            {
//                var sourceNode = FindDiagramNode(modelRelationship.Source.Id);
//                var targetNode = FindDiagramNode(modelRelationship.Target.Id);
...
//        private IDiagramNode FindDiagramNode(ModelItemId modelItemId)
//        {
...
//        private IDiagramConnector FindDiagramConnector(ModelItemId modelItemId)
//        {
...
//        {
//            var diagramNode = FindDiagramNode(oldNode.Id);
