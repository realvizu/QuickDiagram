...
//        {
//            var nodeRects = diagram.Nodes.ToDictionary(i => i.Id, i => groupLayoutInfo.GetBoxById(i.ShapeId).AbsoluteRect);
...
//                layoutGroup.SetChildrenAreaSize(node.Id, childrenAreaLayoutInfo.AbsoluteRect.Size.WithMargin(ChildrenAreaPadding));
...
//                        childrenAreaLayoutInfo?.AbsoluteRect.Size.WithMargin(ChildrenAreaPadding) ?? Size2D.Zero,
